...
<h2 class="header_main_title">Log in</h2>
...
<div>password<br><input class="input" type="password" name="password"></div>
    ...
    <input type="submit" value="log in" class="start-button" />

</form>
<br>
<span style="color:red">fields can`t by empty</span>

<br><br>If you don't have an account on this page click <a href="SignIn">here</a>
